...
class _LecturerLoginScreenState extends State<LecturerLoginScreen> {
  ...
  void _login() {
    if (_formKey.currentState!.validate()) {
      ...
      authProvider
          .signInAsLecturer(_emailController.text, _passwordController.text)
          .then((success) {
            if (mounted) {
              setState(() {
                _isLoading = false;
              ...
              if (success) {
                // Navigasi ke halaman utama dosen
  ...
  Widget _buildSwitchToStudentButton() {
    return TextButton(
      onPressed: () {
        // Navigasi ke halaman login mahasiswa
